...
public:
    ...
    std::list<std::shared_ptr<BankDetail>> get_great_then_by_id(int min, int count) override;
    std::list<std::shared_ptr<BankDetail>> get_less_then_by_id(int max, int count) override;
};
