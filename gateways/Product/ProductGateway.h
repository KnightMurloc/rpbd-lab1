...
public:
    ...
    std::list<std::shared_ptr<Product>> get_great_then_by_id(int min, int count) override;
    std::list<std::shared_ptr<Product>> get_less_then_by_id(int max, int count) override;
};
